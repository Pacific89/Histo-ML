...
if __name__ == "__main__":
    ...
    new_model = tf.train.CheckpointManager().restore_or_initialize(tf.train.latest_checkpoint('/media/user/easystore/tf_ckpts/dense32_dense32_dense32_dense96'))
    # saver = tf.compat.v1.train.Saver()
    # new_model = saver.restore('/media/user/easystore/tf_ckpts/dense32_dense32_dense32_dense96/checkpoint')
    print(new_model)